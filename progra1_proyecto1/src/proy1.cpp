...
int menu()
{
	...
	case 1: cout<<"Se colocan X (cantidad) de discos en uno de los ejes o columnas, en forma decreciente, con el disco mayor en la base"<<endl; 
...
cout<<"con la menor cantidad de movimientos posibles"; break;
